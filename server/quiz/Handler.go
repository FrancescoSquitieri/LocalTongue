...
// GetAll handles GET /quizzes with pagination and optional languageCode filter.
func (h *Handler) GetAll(w http.ResponseWriter, r *http.Request) {
	...
	filter := QuizFilter{LanguageCode: languageCode}
...
// GetLanguages handles GET /quizzes/languages.
